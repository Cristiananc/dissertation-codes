...
#Start graph
e = [(0,1), (1,2), (1,3)] #list of edges
G = nx.Graph(e)

pos = {0: [0,0.5], 1: [0,0], 2: [1,0], 3: [-1,0]}
...
sample_star_graph2 = []
sample_star_graph2.append(sampling1)
sample_star_graph2.append(sampling2)
sample_star_graph2.append(sampling3)

#Saving the sampling obtained using pickle
file_path = 'data/samples/verification_test_star_graphII'
pickle.dump(sample_star_graph2, open(file_path + '.pickle', 'wb'))